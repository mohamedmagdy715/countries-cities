...
export class CountriesService {
  ...
  // url : string = "http://localhost:3000/country";
  url : string = "https://taskfrontendapi.azurewebsites.net/api/country";
  token : string | null = localStorage.getItem('myToken');

  flags : any = {'Afghanistan': 'AF','Albania': 'AL','Algeria': 'DZ','American Samoa': 'AS','Andorra': 'AD','Angola': 'AO','Anguilla': 'AI','Antarctica': 'AQ',
  ...
  'Honduras': 'HN','Hong Kong': 'HK','Hungary': 'HU','Iceland': 'IS','India': 'IN','Indonesia': 'ID','Iran, Islamic Republic of': 'IR','Iran': 'IR','Iraq': 'IQ',
  ...
  'Sao Tome and Principe': 'ST','Saudi Arabia': 'SA','KSA': 'SA','Senegal': 'SN','Serbia': 'RS','Seychelles': 'SC','Sierra Leone': 'SL','Singapore': 'SG',
  ...
  'United Kingdom': 'GB','United States': 'US','USA': 'US','United States Minor Outlying Islands': 'UM','Uruguay': 'UY','Uzbekistan': 'UZ','Vanuatu': 'VU',
